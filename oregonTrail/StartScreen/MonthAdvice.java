...
public class MonthAdvice extends AbstractScreen {
    ...
    protected void initialize() {
        ...
        JLabel infoLbl = new JLabel("<html><center>You attend a public meeting held for 'women - with the California - Oregon fever.' You're told:<bk><bk>If you leave too early, there won't be any grass for your oxen to eat. If you leave too late, you may not get to Oregon before winter comes. If you leave at just the right time, there will be green grass and the weather will still be cool.");
